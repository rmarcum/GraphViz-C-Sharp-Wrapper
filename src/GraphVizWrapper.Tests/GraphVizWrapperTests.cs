...
namespace GraphVizWrapper.Tests
{
    public class GraphVizWrapperTests
    {
        ...
        [Fact]
        public void GenerateGraph_LargeInput_DoesNotCrash()
        {
            // Act
            var diagraph =
        ...
        [Fact]
        public void GenerateGraph_CalledWithPlainTextOutputType_ReturnsCorrectOutput()
        {
            // Act
        ...
        [Fact]
        public void GenerateGraph_CalledWithPlainExtTextOutputType_ReturnsCorrectOutput()
        {
            // Act
